...
class ExtendedECKeyTests: XCTestCase {
  ...
  func testVersionPropagation() {
    ...
    func testExtendedKeySerilization_TestVector1() {
        ...
        // chain - m
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub661MyMwAqRbcFtXgS5sYJABqqG9YLmC4Q1Rdap9gSE8NqtwybGhePY2gZ29ESFjqJoCu1Rupje8YtGqsefD265TMg7usUDFdp6W1EGMcet8")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNNU3TGtRBeJgk33yuGBxrMPHi")
        
        // chain - m/0ʜ
        key = key.childKeyWithHardenedIndex(0)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub68Gmy5EdvgibQVfPdqkBBCHxA5htiqg55crXYuXoQRKfDBFA1WEjWgP6LHhwBZeNK1VTsfTFUHCdrfp1bgwQ9xv5ski8PX9rL2dZXvgGDnw")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9uHRZZhk6KAJC1avXpDAp4MDc3sQKNxDiPvvkX8Br5ngLNv1TxvUxt4cV1rGL5hj6KCesnDYUhd7oWgT11eZG7XnxHrnYeSvkzY7d2bhkJ7")
        
        // chain - m/0ʜ/1
        key = key?.childKeyWithIndex(1)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6ASuArnXKPbfEwhqN6e3mwBcDTgzisQN1wXN9BJcM47sSikHjJf3UFHKkNAWbWMiGj7Wf5uMash7SyYq527Hqck2AxYysAA7xmALppuCkwQ")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9wTYmMFdV23N2TdNG573QoEsfRrWKQgWeibmLntzniatZvR9BmLnvSxqu53Kw1UmYPxLgboyZQaXwTCg8MSY3H2EU4pWcQDnRnrVA1xe8fs")
        
        // chain - m/0ʜ/1/2ʜ
        key = key?.childKeyWithHardenedIndex(2)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6D4BDPcP2GT577Vvch3R8wDkScZWzQzMMUm3PWbmWvVJrZwQY4VUNgqFJPMM3No2dFDFGTsxxpG5uJh7n7epu4trkrX7x7DogT5Uv6fcLW5")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9z4pot5VBttmtdRTWfWQmoH1taj2axGVzFqSb8C9xaxKymcFzXBDptWmT7FwuEzG3ryjH4ktypQSAewRiNMjANTtpgP4mLTj34bhnZX7UiM")
        
        // chain - m/0ʜ/1/2ʜ/2
        key = key?.childKeyWithIndex(2)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6FHa3pjLCk84BayeJxFW2SP4XRrFd1JYnxeLeU8EqN3vDfZmbqBqaGJAyiLjTAwm6ZLRQUMv1ZACTj37sR62cfN7fe5JnJ7dh8zL4fiyLHV")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprvA2JDeKCSNNZky6uBCviVfJSKyQ1mDYahRjijr5idH2WwLsEd4Hsb2Tyh8RfQMuPh7f7RtyzTtdrbdqqsunu5Mm3wDvUAKRHSC34sJ7in334")
        
        // chain - m/0ʜ/1/2ʜ/2/1000000000
        key = key?.childKeyWithIndex(1000000000)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6H1LXWLaKsWFhvm6RVpEL9P4KfRZSW7abD2ttkWP3SSQvnyA8FSVqNTEcYFgJS2UaFcxupHiYkro49S8yGasTvXEYBVPamhGW6cFJodrTHy")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprvA41z7zogVVwxVSgdKUHDy1SKmdb533PjDz7J6N6mV6uS3ze1ai8FHa8kmHScGpWmj4WggLyQjgPie1rFSruoUihUZREPSL39UNdE3BBDu76")
    }
    ...
    func testExtendedKeySerilization_TestVector2() {
        ...
        // chain - m
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEGuduB")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9s21ZrQH143K31xYSDQpPDxsXRTUcvj2iNHm5NUtrGiGG5e2DtALGdso3pGz6ssrdK4PFmM8NSpSBHNqPqm55Qn3LqFtT2emdEXVYsCzC2U")
        
        // chain - m/0
        key = key.childKeyWithIndex(0)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub69H7F5d8KSRgmmdJg2KhpAK8SR3DjMwAdkxj3ZuxV27CprR9LgpeyGmXUbC6wb7ERfvrnKZjXoUmmDznezpbZb7ap6r1D3tgFxHmwMkQTPH")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9vHkqa6EV4sPZHYqZznhT2NPtPCjKuDKGY38FBWLvgaDx45zo9WQRUT3dKYnjwih2yJD9mkrocEZXo1ex8G81dwSM1fwqWpWkeS3v86pgKt")
        
        // chain - m/0/2147483647ʜ
        key = key?.childKeyWithHardenedIndex(2147483647)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6ASAVgeehLbnwdqV6UKMHVzgqAG8Gr6riv3Fxxpj8ksbH9ebxaEyBLZ85ySDhKiLDBrQSARLq1uNRts8RuJiHjaDMBU4Zn9h8LZNnBC5y4a")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9wSp6B7kry3Vj9m1zSnLvN3xH8RdsPP1Mh7fAaR7aRLcQMKTR2vidYEeEg2mUCTAwCd6vnxVrcjfy2kRgVsFawNzmjuHc2YmYRmagcEPdU9")
        
        // chain - m/0/2147483647ʜ/1
        key = key?.childKeyWithIndex(1)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6DF8uhdarytz3FWdA8TvFSvvAh8dP3283MY7p2V4SeE2wyWmG5mg5EwVvmdMVCQcoNJxGoWaU9DCWh89LojfZ537wTfunKau47EL2dhHKon")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprv9zFnWC6h2cLgpmSA46vutJzBcfJ8yaJGg8cX1e5StJh45BBciYTRXSd25UEPVuesF9yog62tGAQtHjXajPPdbRCHuWS6T8XA2ECKADdw4Ef")
        
        // chain - m/0/2147483647ʜ/1/2147483646ʜ
        key = key?.childKeyWithHardenedIndex(2147483646)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6ERApfZwUNrhLCkDtcHTcxd75RbzS1ed54G1LkBUHQVHQKqhMkhgbmJbZRkrgZw4koxb5JaHWkY4ALHY2grBGRjaDMzQLcgJvLJuZZvRcEL")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXWYpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnMpCqE2VbFWc")
        
        // chain - m/0/2147483647ʜ/1/2147483646ʜ/2
        key = key?.childKeyWithIndex(2)
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PublicKey),  "xpub6FnCn6nSzZAw5Tw7cgR9bi15UV96gLZhjDstkXXxvCLsUXBGXPdSnLFbdpq8p9HmGsApME5hQTZ3emM2rnY5agb9rXpVGyy3bdW6EEgAtqt")
        XCTAssertEqual(key.serializeExtendedKey(ofType: .PrivateKey), "xprvA2nrNbFZABcdryreWet9Ea4LvTJcGsqrMzxHx98MMrotbir7yrKCEXw7nadnHM8Dq38EGfSh6dqA9QWTyefMLEcBYJUuekgW4BYPJcr9E7j")
    }
}
