...
class GetDataMessageTests: XCTestCase {
  ...
  func testGetDataMessageDecoding() {
    ...
    if let getDataMessage = GetDataMessage.fromData(data) {
      XCTAssertEqual(getDataMessage.inventoryVectors.count, 3)
      ...
      XCTAssertEqual(getDataMessage.inventoryVectors[0], expectedGetDataVectors[0])
      XCTAssertEqual(getDataMessage.inventoryVectors[1], expectedGetDataVectors[1])
      XCTAssertEqual(getDataMessage.inventoryVectors[2], expectedGetDataVectors[2])
    } else {
